    ...
    public partial class RubySoundV6 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeacherId = table.Column<int>(nullable: false, defaultValueSql: "NEXT VALUE FOR shared.TeacherIdSequence"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommunityId = table.Column<int>(nullable: false, defaultValueSql: "NEXT VALUE FOR shared.CommunityIdSequence"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Communitys", x => x.CommunityId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudentId = table.Column<int>(nullable: false, defaultValueSql: "NEXT VALUE FOR shared.StudentIdSequence"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Birthday = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Gender = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Email = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
